# 한잔하주(기분과 상황에 어울리는 술집 매칭서비스)

감정과 상황 기반 맞춤형 술집 매칭 FastAPI 백엔드

## 📋 프로젝트 개요

사용자의 **감정 상태**와 **상황**에 따라 광주 지역 술집을 매칭하는 시스템입니다.
...
### 장점
- ✅ **개인화**: 감정과 상황에 맞춤 서비스
- ✅ **확장성**: 새로운 감정/상황 추가 용이, 술집뿐만아닌 음식점, 카페 등... 확장성이 좋음
- ✅ **지역화**: 광주 지역 특화
...
- **이름**: 동인
- **역할**: 백엔드 개발 (FastAPI, 매칭 알고리즘)
- **프로젝트**: 한잔하주(기분과 상황에 어울리는 술집 매칭서비스)
